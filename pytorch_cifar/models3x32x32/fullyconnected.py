...
def FCNet3000(num_classes: int = 10):
    return FullyConnectedModel(3*32*32, num_classes, [(3000, 'relu')])

def FCNet1000(num_classes: int = 10):
    return FullyConnectedModel(3*32*32, num_classes, [(1000, 'relu')])

def FCNet100(num_classes: int = 10):
    return FullyConnectedModel(3*32*32, num_classes, [(100, 'relu')])
